-- MariaDB 11.x Compatible SQL Dataset
-- Stress testing dataset with advanced features (JSON, stored procedures, triggers)
-- Compatible with MariaDB 11.0 and later
