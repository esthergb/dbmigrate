...
- State:
  - Branch: `codex/feat/replication-mode-phase32` with local phase changes in progress.
...
- Now:
  - Commit/push Phase 32 and open PR.
- Next:
  - Validate CI for Phase 32 PR (`validate`, fallback `make ci-manual` if needed).
  - Merge Phase 32 PR and continue with next phase branch.
